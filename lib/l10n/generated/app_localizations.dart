...
abstract class S {
  ...
  /// No description provided for @spotDistance.
  ///
  /// In en, this message translates to:
  /// **'Spot distance'**
  String get spotDistance;

  /// No description provided for @cannon.
  ///
  /// In en, this message translates to:
  /// **'Cannon'**
  String get cannon;

  /// Title line for the selected tower.
  ///
  /// In en, this message translates to:
  /// **'{towerType} (Lv {level})'**
  ...
  /// No description provided for @maxLevelTooltip.
  ///
  /// In en, this message translates to:
  /// **'Max level'**
  String get maxLevelTooltip;
